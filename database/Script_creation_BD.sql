...
CREATE TABLE Mission (
                         ...
                         stateOfMission NUMBER(1) REFERENCES MissionState(id),
...
ALTER TABLE TimeSlot ADD CONSTRAINT TimeSlotUnique UNIQUE (startDateTime, endDateTime, day);
