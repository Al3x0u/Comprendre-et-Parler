...
class BaseTimeSlotTest {
    ...
    public void initTime() {
        b1 = new BaseTimeSlot(1, LocalTime.NOON, LocalTime.NOON.plusHours(1), DayOfWeek.MONDAY);
    }
    ...
    public void testOverlaps() {
        ...
        BaseTimeSlot b2 = new BaseTimeSlot(2, LocalTime.NOON.minusHours(1), LocalTime.NOON.plusHours(1), DayOfWeek.TUESDAY);
