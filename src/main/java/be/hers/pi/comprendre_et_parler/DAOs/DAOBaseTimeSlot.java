...
public class DAOBaseTimeSlot implements DAO<BaseTimeSlot> {
     ...
     * @post objectToInsert has been added to the database, and the change was commited. objectToInsert's id field was changed to the one auto-generated by the database
    ...
    public void delete(BaseTimeSlot objectToDelete) throws NoSuchElementException, SQLException {
        ...
        if (objectInDB == null || !objectInDB.equals(objectToDelete))
