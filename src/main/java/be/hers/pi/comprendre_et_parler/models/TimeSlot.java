...
public abstract class TimeSlot {
    ...
    public boolean overlapsCompletely(TimeSlot timeSlot) {
        ...
        return (this.startTime.isBefore(timeSlot.startTime) && this.endTime.isAfter(timeSlot.endTime))
                || (this.startTime.isAfter(timeSlot.startTime) && !this.endTime.isAfter(timeSlot.endTime));    }
